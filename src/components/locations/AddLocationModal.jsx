...
const AddLocationModal = ({lat ,lng ,setAdding ,
    setPending }) => {
        // JS
  ...
  return (
    ...
    justify-center z-[9999]">
        <div className="bg-white p-6 rounded-2xl shadow-2xl w-96">
            ...
            <input
            className ="w-full border px-4 py-2 border-gray-300 
            rounded-md mb-4 focus:outline-none focus:ring-purple-500
            focus:ring-2"
            ...
            <div  className="flex gap-4">
                ...
                text-white py-3 rounded-md hover:bg-purple-800
                disabled:cursor-not-allowed"
                onClick={hdlAddLocation}
                disabled={!name.trim()}
                >Save</button>

                <button className="flex-1 bg-gray-300
